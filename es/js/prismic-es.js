...
const routes = [
  { type: 'homepage', uid: 'homepage', path: '/es/index.html' },
  { type: 'clients_page', uid: 'clients_page', path: '/es/clients/index.html' },
];
...
const init = async () => {
  ...
  const homepageDoc = await client.getSingle('homepage', { lang: 'es-mx' });
  ...
  if (pathname == '/es/index.html' || pathname == '/es/') {
  ...
  } else if (pathname == '/es/clients.html' || pathname == '/es/clients/') {
