...
const routes = [
  { type: 'homepage', uid: 'homepage', path: '/fr/index.html' },
  { type: 'clients_page', uid: 'clients_page', path: '/fr/clients/index.html' },
];
...
const init = async () => {
  ...
  const homepageDoc = await client.getSingle('homepage', { lang: 'fr-fr' });
  ...
  if (pathname == '/fr/index.html' || pathname == '/fr/') {
  ...
  } else if (pathname == '/fr/clients.html' || pathname == '/fr/clients/') {
