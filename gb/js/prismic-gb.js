...
const routes = [
  { type: 'homepage', uid: 'homepage', path: '/gb/index.html' },
  { type: 'clients_page', uid: 'clients_page', path: '/gb/clients/index.html' },
];
...
if (
  window.location.pathname === '/gb/index.html' ||
...
const init = async () => {
  ...
  const homepageDoc = await client.getSingle('homepage', { lang: 'en-gb' });
  ...
  if (pathname == '/gb/index.html' || pathname == '/gb/') {
  ...
  } else if (pathname == '/gb/clients.html' || pathname == '/gb/clients/') {
