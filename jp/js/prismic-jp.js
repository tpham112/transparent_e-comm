...
const routes = [
  { type: 'homepage', uid: 'homepage', path: '/jp/index.html' },
  { type: 'clients_page', uid: 'clients_page', path: '/jp/clients/index.html' },
];
...
const init = async () => {
  ...
  const homepageDoc = await client.getSingle('homepage', { lang: 'ja-jp' });
  ...
  if (pathname == '/jp/index.html' || pathname == '/jp/') {
  ...
  } else if (pathname == '/jp/clients.html' || pathname == '/jp/clients/') {
